...
COLOR_INT_PIECE_KING = Color(*COLOR_PIECE_KING)
COLOR_INT_PIECE_QUEEN = Color(*COLOR_PIECE_QUEEN)
COLOR_INT_PIECE_ROOK = Color(*COLOR_PIECE_ROOK)
COLOR_INT_PIECE_BISHOP = Color(*COLOR_PIECE_BISHOP)
COLOR_INT_PIECE_KNIGHT = Color(*COLOR_PIECE_KNIGHT)
COLOR_INT_PIECE_PAWN = Color(*COLOR_PIECE_PAWN)
COLOR_INT_SETUP_MISSING = Color(*COLOR_SETUP_MISSING)
COLOR_INT_SETUP_MISPLACED = Color(*COLOR_SETUP_MISPLACED)
...
COLOR_INT_NIGHT_PIECE_KING = Color(*COLOR_NIGHT_PIECE_KING)
COLOR_INT_NIGHT_PIECE_QUEEN = Color(*COLOR_NIGHT_PIECE_QUEEN)
COLOR_INT_NIGHT_PIECE_ROOK = Color(*COLOR_NIGHT_PIECE_ROOK)
COLOR_INT_NIGHT_PIECE_BISHOP = Color(*COLOR_NIGHT_PIECE_BISHOP)
COLOR_INT_NIGHT_PIECE_KNIGHT = Color(*COLOR_NIGHT_PIECE_KNIGHT)
COLOR_INT_NIGHT_PIECE_PAWN = Color(*COLOR_NIGHT_PIECE_PAWN)
